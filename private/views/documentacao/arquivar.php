...
try {
    ...
    $sql = "UPDATE documentos SET arquivado = 1 WHERE id = :id";
    $stmt = $ligacao->prepare($sql);
    $stmt->execute([':id' => $id_desencriptado]);

    // 4. Feedback de Sucesso e Redirecionamento
    $_SESSION['success_message'] = "O documento foi abatido com sucesso.";
    
} catch (PDOException $e) {
    // Isola o erro técnico para não expor a estrutura do servidor ao utilizador
    $_SESSION['error_message'] = "Erro interno ao tentar abater o documento selecionado.";
}

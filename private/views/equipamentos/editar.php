            ...
            <main class="col-md-9 col-lg-10">
                <div
                    ...
                    <div class="mb-4 pb-2 border-bottom">
                        <h2 class="fw-bold text-dark m-0">Modificar Registo <span
                                class="text-success">#EQ-98921-XFA</span></h2>
                        <p class="text-muted small m-0">Atualize as informações operacionais ou reposicionamento de
                            serviço.</p>
                    </div>

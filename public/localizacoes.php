    ...
    <main class="container my-5">
        <section class="bg-white p-5 rounded-4 shadow-sm mb-5">
            <div class="d-flex justify-content-between align-items-center mb-4">
                <div>
                    <h1 class="fw-bold text-dark">Localizações Hospitalares</h1>
                    <p class="text-muted">Consulte o inventário público de serviços e localizações do hospital.</p>
                </div>
            ...
            <div class="alert alert-info rounded-3">
                ...
                A listagem pública de localizações estará disponível após a ligação à base de dados.
